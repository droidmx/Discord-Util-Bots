...
client.on('message', async msg => {
	...
	var newrealmargs = newrealmmsg.replace(']\n', ' ')
	var newrealmargs = newrealmargs.split(' ');
	var newrealmmsg = newrealmargs.slice(1).join(' ');
	...
	client.channels.get('473859409580130304').send(newrealmmsg)
	}
